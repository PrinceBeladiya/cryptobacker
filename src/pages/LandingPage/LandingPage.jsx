  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:px-6">
      ...
      <section className="bg-white">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <h2 className="mb-4 text-4xl font-extrabold tracking-tight text-gray-900">Ready to Make an Impact?</h2>
          <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48">Join CryptoBacker today and turn your vision into reality. Start your crowdfunding campaign or explore projects that inspire you.</p>
          <NavLink to="/signup" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
            Get Started
            <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1.528-5.455a.75.75 0 00-1.056-1.05L12.79 10H7a.75.75 0 000-1.5h5.79l-2.318-2.318a.75.75 0 101.057-1.057l3.75 3.75a.75.75 0 000 1.06l-3.75 3.75a.75.75 0 00-1.057 0z" clipRule="evenodd"></path>
            </svg>
          </NavLink>
        </div>
      </section>
